...
"            :let hhcs_gui_hhdgray_nontext    ="normal"
...
hi NonText                   gui=NONE        guifg=black       guibg=blue
...
hi StatusLineNC            cterm=NONE      ctermfg=darkgray     ctermbg=white
hi LineNr                    gui=NONE        guifg=lightgray      guibg=black
hi LineNr                  cterm=NONE      ctermfg=lightgray    ctermbg=black
hi VertSplit                 gui=NONE        guifg=darkgray       guibg=gray
hi VertSplit               cterm=NONE      ctermfg=darkgray     ctermbg=white
" title
...
hi MoreMsg                 cterm=NONE      ctermfg=green        ctermbg=black
hi Question                  gui=NONE        guifg=black          guibg=darkgray
hi Question                cterm=NONE      ctermfg=green        ctermbg=black
