...
let colors_name = "mycandy"

hi Normal       guifg=#fff1dd guibg=#000000

" Search
hi IncSearch    gui=UNDERLINE guifg=#80ffff guibg=#0060c0
hi Search       gui=NONE guifg=#fff1dd guibg=#0060c0
...
" Cursor
hi Cursor       gui=NONE guifg=#00ffff guibg=#8800ff
...
hi Title        gui=BOLD guifg=#fff1dd guibg=NONE
hi Visual       gui=NONE guifg=#e0e0f0 guibg=#707080

" Syntax group
hi Comment      gui=NONE guifg=#7e99ae guibg=NONE
...
hi Underlined   gui=UNDERLINE guifg=#fff1dd guibg=NONE
hi Number       gui=NONE guifg=#ff0000 guibg=NONE
hi String       gui=NONE guifg=#ff6d34 guibg=NONE
